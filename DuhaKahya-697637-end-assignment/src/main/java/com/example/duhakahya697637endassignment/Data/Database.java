...
public class Database {
    ...
    private boolean dataFileExists = false;
    ...
    private void loadStandardData() {
        ...
        initializeDefaultData(); // Initialize default data when files are missing
    ...
    private void load() {
        ...
        // Add default data regardless of whether the data file exists
        initializeDefaultData();

        if (!dataFileExists) {
            // If the data file didn't exist, save the default data
            save();
        }
    }
